...
public class TerrainTileFX extends StackPane {
    ...
    public TerrainTileFX(TerrainTile tile) {
        this.tile = tile;
        overlay = new Rectangle((int) 700 / GridFX.getMapLength(),
            (int) 700 / GridFX.getMapLength(), Color.rgb(0, 0, 0, 0.0));
        overlay.setStroke(Color.BLACK);
        this.background = new ImageView(tile.getImage());
        this.background.setFitWidth((int) 700 / GridFX.getMapLength());
        this.background.setFitHeight((int) 700 / GridFX.getMapLength());
    ...
    public void updateTileView() {
        ...
        if (!(tile.isEmpty())) {
            ...
            icon.setFitWidth((int) 350 / GridFX.getMapLength());
            icon.setFitHeight((int) 350 / GridFX.getMapLength());
